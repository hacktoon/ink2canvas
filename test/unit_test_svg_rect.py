...
class TestRect(unittest.TestCase):
    def setUp(self):
        self.effect = Effect()
        self.document = None
        self.effect.parse("arquivos_test/unit_test_svg_Rect_WithRxRy.svg")
        self.node = None
    ...
    def testExitWithoutRxRy(self):
        self.document = self.effect.parse("arquivos_test/unit_test_svg_Rect_WithoutRxRy.svg")
    ...
    def testExitWithRxRy(self):
        self.document = self.effect.parse("arquivos_test/unit_test_svg_Rect_WithRxRy.svg")
        root = self.effect.document.getroot()
        self.rect = Rect(None, self.node, self.canvas, None)
        self.rect.node = self.findNodeInG(root, 'rect')
        x, y, w, h, rx, ry = self.rect.getData()
